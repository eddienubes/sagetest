...
> **`readonly`** **x\_b**: `"model/vnd.parasolid.transmit.binary"` = `'model/vnd.parasolid.transmit.binary'`

### x\_t

> **`readonly`** **x\_t**: `"model/vnd.parasolid.transmit.text"` = `'model/vnd.parasolid.transmit.text'`
...
[src/constants.ts:85](https://github.com/eddienubes/sagetest/blob/e842b4f/src/constants.ts#L85)
